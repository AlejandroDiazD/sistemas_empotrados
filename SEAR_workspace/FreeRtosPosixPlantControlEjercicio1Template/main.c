...
void LEDTask( void *pvParmeters )
{
    ...
    while(1)
    {
		...
		vTaskDelayUntil(&xSwitchOnWakeTime, LED_CYCLE_TICKS/2);
		printf("    LED OFF\n\n");
    }
}
